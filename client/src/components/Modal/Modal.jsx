    ...
    const startQuestionnaire = () => {
        return (
            <>
                ...
                <p className="instruction" style={{ padding: "0em 0em 1em 0em", color: "#3d2903" }}>
                    {instruction}
                </p>
                <div style={{
                    textAlign: "center", display: "table", width: "100%",
                }}>
                    <Button style={{ width: "90%", textAlign: "center", fontSize: "1.3em", backgroundColor: "#84123c", border: "none" }} onClick={setStarterOn} className="btn-submit">{startButton}</Button>
                </div>
            </>
        )
    }
